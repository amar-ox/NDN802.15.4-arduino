...
#ifndef FORWARDING_INFORMATION_BASE_HPP
#define FORWARDING_INFORMATION_BASE_HPP
...
{
  public:
  ForwardingInformationBase() : fib_size_(0) {}
  ~ForwardingInformationBase() { delete[] entries_; }
